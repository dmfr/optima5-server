 ...
 *     tpl.overwrite(panel.body, data);
 */
Ext.define('Ext.calendar.template.XTemplate', {
    extend: 'Ext.calendar.template.Template',

    requires: 'Ext.calendar.template.XTemplateCompiler',
    ...
    applyOut: function(values, out) {
        ...
        if (!me.fn) {
            compiler = new Ext.calendar.template.XTemplateCompiler({
