Ext.define('AbsoCrmMenuItemModel',{
...
Ext.define('Optima5.Modules.Spec.AbsoCrm.MainMenu',{
	...
	initComponent: function() {
		...
		var itemsStore = Ext.create('Ext.data.Store',{
			model:'AbsoCrmMenuItemModel',
			data:[
				{type_header:true},
				{type_separator:true, separator_label: 'Analysis / Queries'},
				{type_action:true, action_caption: 'Month Dashboard', action_sendEvent:'dashboard_month', action_iconCls:'op5-spec-dbspeople-icon-forecast'},
