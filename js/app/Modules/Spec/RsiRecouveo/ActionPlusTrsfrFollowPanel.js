Ext.define('Optima5.Modules.Spec.RsiRecouveo.ActionPlusTrsfrFollowPanel',{
					...
					items: [
						{
							...
							boxLabel  : 'Fin du transfert<br><i>Retour dossier "en cours"</i>',
							name      : 'schedlock_next',
							inputValue: 'end'
						}
					]
