Ext.define('Optima5.Modules.Spec.WbSales.QueryPanel',{
	extend: 'Ext.panel.Panel',
	
	requires:[
		'Optima5.Modules.Spec.WbSales.TreePicker',
		'Optima5.Modules.Spec.WbSales.QueryResultView'
	],
		...
		var formCfg = {
			...
			items:[{
				...
				items:[{
					...
					items:[Ext.create('Optima5.Modules.Spec.WbSales.TreePicker',{
						width: 250,
						treeModel: 'WbSalesCfgCountryModel',
						treeRoot: Optima5.Modules.Spec.WbSales.HelperCache.countryGetRoot(),
						name : 'country_code',
						itemId : 'country_code',
						listeners: {
							change: function() {
					...
					items:[{
						...
						width: 250,
						name: 'treeview_mode',
						fieldLabel: 'Treeview by',
						forceSelection: true,
						editable: false,
						store: {
							fields: ['mode','lib'],
							data : [
								{mode:'CUSTOMER', lib:'Customers'},
								{mode:'PRODUCT', lib:'Products'}
							]
						},
						queryMode: 'local',
						displayField: 'lib',
						...
						listeners: {
							change: function(cb,value) {
								cb.up().up().down('#cntDetails').setVisible(value=='CUSTOMER');
							},
							scope: me
						}
					},{
					...
					items:[{
						...
						name: 'has_x',
						width: 200,
						boxLabel: 'Product on columns',
						submitValue: 1,
						checked: true,
						listeners: {
							change: function(cb,value) {
								var selectValue = cb.up().down('#selectValue') ;
								selectValue.setVisible(value) ;
								//me.evalForm() ;
							},
							scope: me
						}
						...
						store: {
							fields: ['mode','lib'],
							data : [
								{mode:'CA', lib:'Turnover / Sales'},
								{mode:'VOLKG', lib:'Volume Kg'},
								{mode:'VOLLBS', lib:'Volume Lbs'}
							]
						},
						queryMode: 'local',
						displayField: 'lib',
	...
	installPreview: function( ajaxData ) {
		var me = this ;
		me.query('#cntQueryPreview')[0].add( Ext.create('Optima5.Modules.Spec.WbSales.QueryResultView',{
			optimaModule: me.optimaModule,
			data: ajaxData,
			modePreview: true,
			border: false,
	...
	savePreview: function( ajaxData ) {
		...
		tabpanel.add( Ext.create('Optima5.Modules.Spec.WbSales.QueryResultView',{
			optimaModule: me.optimaModule,
			data: ajaxData,
