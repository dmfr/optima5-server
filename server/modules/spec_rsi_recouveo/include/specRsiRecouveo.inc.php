...
include("$server_root/modules/spec_rsi_recouveo/include/specRsiRecouveo_risk.inc.php") ;
...
include("$server_root/modules/spec_rsi_recouveo/include/specRsiRecouveo_lib_transfert.php") ;
