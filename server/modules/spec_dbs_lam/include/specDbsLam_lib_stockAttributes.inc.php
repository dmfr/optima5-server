...
function specDbsLam_lib_stockAttributes_getStockAttributes() {
	if( isset($GLOBALS['cache_specDbsLam_lib_stockAttributes']['stockAttributes']) ) {
		return $GLOBALS['cache_specDbsLam_lib_stockAttributes']['stockAttributes'] ;
	}
	...
	return ($GLOBALS['cache_specDbsLam_lib_stockAttributes']['stockAttributes'] = $TAB) ;
}
