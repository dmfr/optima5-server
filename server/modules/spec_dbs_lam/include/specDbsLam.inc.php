...
include("$server_root/modules/spec_dbs_lam/include/specDbsLam_lib_procCde.inc.php") ;

include("$server_root/modules/spec_dbs_lam/include/specDbsLam_lib_TMS.inc.php") ;
