...
$query = "DELETE FROM input_scen_page WHERE scen_id='$scen_id' AND scen_page_index='$scen_page_index'" ;
$_opDB->query($query) ;
$query = "UPDATE input_scen_page 
				...
				ORDER BY scen_page_index ASC" ;
$_opDB->query($query) ;

$query = "DELETE FROM input_scen_page_field WHERE scen_id='$scen_id' AND scen_page_index='$scen_page_index'" ;
$_opDB->query($query) ;
...
$query = "UPDATE input_scen_page_field 
				...
				ORDER BY scen_page_parent_index ASC" ;
$_opDB->query($query) ;

$query = "DELETE FROM input_scen_pagepivot WHERE scen_id='$scen_id' AND scen_page_index='$scen_page_index'" ;
$_opDB->query($query) ;
...
$query = "UPDATE input_scen_pagepivot 
				...
				ORDER BY target_page_index ASC" ;
$_opDB->query($query) ;
$query = "UPDATE input_scen_pagepivot 
				...
				ORDER BY foreignsrc_page_index ASC" ;
$_opDB->query($query) ;

$query = "DELETE FROM input_scen_pagepivot_copymap WHERE scen_id='$scen_id' AND scen_page_index='$scen_page_index'" ;
$_opDB->query($query) ;
